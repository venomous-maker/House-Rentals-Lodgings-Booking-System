...
<head>
  ...
  <title>ELLINS HOSTEL AND ACCOMMODATION | MEALS</title>
  ...
  <section class="container bg-light py-2" id="result">
    ...
    <div>
      ...
      <form action="search.php" method="POST" class="form-inline" style="display: inline;">
        <input class="form-control mr-sm-2 ml-sm-3" type="text" name="q" placeholder="Search for houses..." aria-label="Search">
    ...
    if (isset($_POST['search'])) {
      $query = mysqli_query($connect, "SELECT * FROM `menu` WHERE NAME_OF_FOOD LIKE '%" . $_POST['q'] . "%' OR CAT_OF_FOOD LIKE '%" . $_POST['q'] . "%' OR PRICE LIKE '%" . $_POST['q'] . "%'");
    ...
    ?>
        ...
        <?php if ($rows < 1) {
          echo '
		                              <button class="btn btn-success text-center my-2 addItemBtn" name="add_to_cart"><i class="fas fa-shopping-cart"></i>Book</button>';
        } else {
          echo '<button class="btn btn-success text-center my-2 addItemBtn" name="add_to_cart"><i class="fas fa-shopping-cart"></i>Booked</button>';
        } ?>
    <?php
        echo '</form>';
        echo '</div>';
    ...
    <div class="content justify-content-center">
      <div class="row">
        <div class="col-lg-6 col-md-6">
          ...
          <h5>CONTACTS</h5>
          <p><i class="fas fa-home"></i>Nyamage Primary School,kitui,P.O. Box ***-******</p>
      ...
      <h2>ELLINS HOSTEL AND ACCOMMODATION,COPYRIGHT &copy;2020</h2>
    </div>
